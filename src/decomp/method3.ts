...
export function decomp(number: number): string {
  // function that adds the dividers of a number to a "dividers object"
  const subdecomp = (number: number, subdividers: { [x: number]: number }) => {
